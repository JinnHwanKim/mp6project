                ...
                <div id="content">
                    ...
                    <div>
                        ...
                        <span class="box int_name">
                            <input type="text" name="m_name" id="name" class="int" maxlength="20">
                        </span>
                    ...
                    <div>
                        ...
                        <span class="box int_id">
                            <input type="text" name="m_id" id="id" class="int" maxlength="20">
                        </span>
                        <span class="error_next_box"></span>
                    </div>
                    ...
                    <div>
                        ...
                        <div id="bir_wrap">
                            ...
                            <div id="bir_mm">
                                <span class="box">
                                    <select id="mm" name="m_mm" class="sel">
                                        <option>월</option>
                    ...
                    <div>
                        ...
                        <span class="box gender_code">
                            <select id="gender" name="m_gender" class="sel">
                                <option>성별</option>
